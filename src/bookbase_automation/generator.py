...
def build_image_context(script: str, book_title: str, asset_checks: list[AssetCheck] | None = None) -> dict[str, object]:
    ...
    context = {
        ...
        "scene_bodies": {"scene_02": scene2, "scene_03": scene3, "scene_05": scene5, "scene_06": scene6, "scene_07": scene7, "scene_09": scene9, "scene_10": scene10, "scene_11": scene11, "scene_12": scene12, "scene_13": scene13, "scene_14": scene14, "scene_15": scene15, "scene_16": scene16, "scene_17": scene17, "scene_18": scene18, "scene_20": scene20},
        "assets": {
...
def _apply_scene3_script_template(scenes: Any, *, source_text: str, book_title: str) -> Any:
...
""".strip()
    ...
    for attempt in range(1, 4):
        ...
        try:
            data["scenes"] = _apply_scene3_script_template(data["scenes"], source_text=source_text, book_title=book_name)
